...
internal sealed record WorkbenchQuestRunOptions(
    string ScenarioId,
    PlannerKind Planner,
    string? ModelId,
    ...
    string? Error)
{
    public static WorkbenchQuestRunOptions Parse(IReadOnlyList<string> args)
    {
        ...
        for (var index = 0; index < args.Count; index++)
        {
            ...
            if (!arg.StartsWith("--", StringComparison.Ordinal))
            {
                ...
                {
                    return Invalid($"Unexpected workbench argument '{arg}'.");
                }
        ...
        return new WorkbenchQuestRunOptions(
    ...
    private static WorkbenchQuestRunOptions Invalid(string error) =>
        new(
            "broken_check",
