...
{
    return await ProductProofBenchmarkCommand.RunAsync(
        args.Skip(1).ToArray(),
        GeminiCredentialsAvailable);
}
    ...
    IReadOnlyList<string> args)
{
    ...
    var writer = RunLogWriter.Create(
        logDir,
        scenario,
        warning: message => Console.Error.WriteLine(message));
    if (!writer.IsEnabled)
    {
        return null;
    }
...
static void PrintUsage()
{
    ...
    Console.Error.WriteLine("  Agentica.Lab mazequest preview <quest-id> [--seed <number>] [--type unlock|collect|delivery|explore|activate|puzzle|rescue|resource] [--width <odd 7-15>] [--height <odd 7-15>] [--visibility <1-4>] [--reveal] [--json]");
    Console.Error.WriteLine("  Agentica.Lab mazequest run [quest-id] [--planner deterministic|gemini] [--planning-mode stepwise|query-blocker|blocker|plan-only] [--max-blocked-retries <count>] [--seed <number>] [--type unlock|collect|delivery|explore|activate|puzzle|rescue|resource] [--watch] [--narrator off|deterministic|gemini] [--turn-json] [--watch-delay-ms <ms>] [--timeout-seconds <seconds>] [--model <model-id>] [--narration-model <model-id>] [--thinking-budget dynamic|off|<tokens>] [--include-thoughts] [--log-run] [--log-dir <path>]");
    Console.Error.WriteLine("  Agentica.Lab workbench list");
    Console.Error.WriteLine("  Agentica.Lab workbench preview [scenario-id]");
    Console.Error.WriteLine("  Agentica.Lab workbench run [scenario-id] [--planner deterministic|gemini] [--planning-mode stepwise|query-blocker|blocker|plan-only] [--max-blocked-retries <count>] [--timeout-seconds <seconds>] [--model <model-id>] [--thinking-budget dynamic|off|<tokens>] [--include-thoughts] [--log-run] [--log-dir <path>]");
    Console.Error.WriteLine("  Agentica.Lab hexquest list");
    Console.Error.WriteLine("  Agentica.Lab hexquest preview [scenario-id]");
    Console.Error.WriteLine("  Agentica.Lab hexquest run [scenario-id] [--planner deterministic|gemini] [--planning-mode stepwise|query-blocker|blocker|plan-only] [--max-blocked-retries <count>] [--timeout-seconds <seconds>] [--model <model-id>] [--thinking-budget dynamic|off|<tokens>] [--max-output-tokens <count>] [--include-thoughts] [--log-run] [--log-dir <path>]");
    Console.Error.WriteLine("  Agentica.Lab chessquest list");
    Console.Error.WriteLine("  Agentica.Lab chessquest preview [scenario-id]");
    Console.Error.WriteLine("  Agentica.Lab chessquest board-probe [--trials <count>] [--seed <number>] [--scramble-plies <count>] [--presentation ascii|fen|both] [--target occupied|empty|mixed] [--model <model-id>] [--thinking-budget dynamic|off|<tokens>] [--max-output-tokens <count>] [--timeout-seconds <seconds>] [--json] [--log-run] [--log-dir <path>]");
    Console.Error.WriteLine("  Agentica.Lab chessquest legal-action-probe [--trials <count>] [--seed <number>] [--scramble-plies <count>] [--presentation ascii|fen|both] [--model <model-id>] [--thinking-budget dynamic|off|<tokens>] [--max-output-tokens <count>] [--timeout-seconds <seconds>] [--json] [--log-run] [--log-dir <path>]");
    Console.Error.WriteLine("  Agentica.Lab chessquest puzzle-probe [--trials <count>] [--presentation ascii|fen|both] [--model <model-id>] [--thinking-budget dynamic|off|<tokens>] [--max-output-tokens <count>] [--timeout-seconds <seconds>] [--json] [--log-run] [--log-dir <path>]");
    Console.Error.WriteLine("  Agentica.Lab chessquest state-probe [--probe-kind legality|capture|check|material|phase|stacked] [--trials <count>] [--seed <number>] [--scramble-plies <count>] [--presentation ascii|fen|both] [--model <model-id>] [--thinking-budget dynamic|off|<tokens>] [--max-output-tokens <count>] [--timeout-seconds <seconds>] [--json] [--log-run] [--log-dir <path>]");
    Console.Error.WriteLine("  Agentica.Lab chessquest replay <game-record-file|run-log-directory>");
    Console.Error.WriteLine("  Agentica.Lab chessquest resume <game-record-file|run-log-directory> [run options]");
    Console.Error.WriteLine("  Agentica.Lab chessquest run [scenario-id] [--planner deterministic|gemini] [--planning-mode stepwise|query-blocker|blocker|plan-only] [--strategy-mode off|phase|projected] [--phase opening|tactical|endgame] [--phase-max-agent-turns <count>] [--max-steps <count>] [--max-refinements <count>] [--max-plan-continuations <count>] [--max-blocked-retries <count>] [--timeout-seconds <seconds>] [--opponent random|heuristic|agent] [--opponent-difficulty beginner|club|strong|max] [--opponent-planner deterministic|gemini] [--opponent-model <model-id>] [--opponent-thinking-budget dynamic|off|<tokens>] [--opponent-max-output-tokens <count>] [--opponent-max-steps <count>] [--opponent-max-refinements <count>] [--opponent-timeout-seconds <seconds>] [--opponent-seed <number>] [--quiet] [--verbose-events] [--turn-json] [--verbose-envelope] [--model <model-id>] [--thinking-budget dynamic|off|<tokens>] [--max-output-tokens <count>] [--include-thoughts] [--log-run] [--log-dir <path>]");
    Console.Error.WriteLine("  Agentica.Lab chessquest orchestrate [scenario-id] [--task-planner deterministic|gemini] [--run-planner deterministic|gemini] [--task-model <model-id>] [--run-model <model-id>] [--phase-max-agent-turns <count>] [--max-orchestration-runs <count>] [--max-orchestration-refinements <count>] [--max-graph-mutations <count>] [--max-steps <count>] [--max-refinements <count>] [--max-plan-continuations <count>] [--timeout-seconds <seconds>] [--opponent random|heuristic|agent] [--opponent-difficulty beginner|club|strong|max] [--thinking-budget dynamic|off|<tokens>] [--max-output-tokens <count>] [--include-thoughts] [--log-run] [--log-dir <path>]");
    Console.Error.WriteLine("  Agentica.Lab campaign list");
    Console.Error.WriteLine("  Agentica.Lab campaign run [campaign-id] [--planner deterministic|gemini] [--planning-mode stepwise|query-blocker|blocker|plan-only] [--max-blocked-retries <count>] [--model <model-id>] [--thinking-budget dynamic|off|<tokens>] [--max-output-tokens <count>] [--include-thoughts] [--log-run] [--log-dir <path>]");
    ProductProofBenchmarkCommand.PrintUsage();
    Console.Error.WriteLine("  Agentica.Lab orchestrate \"<objective>\" [--task-planner deterministic|gemini] [--model <model-id>]  [EXPERIMENTAL / QUARANTINED]");
}
