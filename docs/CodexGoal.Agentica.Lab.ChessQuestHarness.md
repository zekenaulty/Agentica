# Codex Goal: Agentica.Lab ChessQuest Harness

> Lifecycle: **Incubating** · Completion: **80%** · Canonical status: [Agentica Product Status And Goal Xref](Agentica.ProductStatus.md)
...
```powershell
dotnet run --project .\Agentica.Lab -- chessquest action-probe --trials 25 --scramble-plies 24 --objective any-legal --presentation ascii --log-run
```
