...
| Invalid plan | 2/30 (6.7%) | 0/25 | 2/5 (40%) |
...
The final local gate on 2026-07-21 used SDK 10.0.302: locked restore, formatting, selected security analyzers, and the Release warnings-as-errors build passed; 390 tests passed, 2 opt-in live Gemini tests were explicitly skipped, and 0 failed; fresh core coverage was 84.84% line and 67.52% branch against 80%/60% floors; vulnerability and deprecation audits were clean; both research-preview packages passed validation plus a fresh temporary external-consumer build; and the Lab executable passed a real-process smoke.
