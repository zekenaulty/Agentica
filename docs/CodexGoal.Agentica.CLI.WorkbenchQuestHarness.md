# Codex Goal: Agentica.CLI WorkbenchQuest Harness

## Mission

Build a host-provided WorkbenchQuest test harness inside `Agentica.CLI`.
...
This is not an Agentica runtime feature. It is a CLI host scenario that supplies domain state, files, checks, patching tools, completion rules, and optional watch output around Agentica's existing planner/executor loop.
...
```text
Agentica.CLI/Scenarios/WorkbenchQuest/
```
...
- Added `Agentica.CLI/Scenarios/WorkbenchQuest/`.
...
- Add `Agentica.CLI/Scenarios/WorkbenchQuest/`.
...
dotnet run --project Agentica.CLI -- workbench list
dotnet run --project Agentica.CLI -- workbench preview broken_check
dotnet run --project Agentica.CLI -- workbench run broken_check --planner deterministic --timeout-seconds 120
```
...
dotnet run --project Agentica.CLI -- workbench run missing_mapping --planner deterministic --timeout-seconds 120
# Succeeded with workbench.objective_completed artifact

dotnet run --project Agentica.CLI -- workbench run structured_doc_merge --planner deterministic --timeout-seconds 120
# Succeeded with workbench.objective_completed artifact

dotnet run --project Agentica.CLI -- workbench run word_ladder --planner deterministic --timeout-seconds 120
# Succeeded with workbench.objective_completed artifact
...
dotnet run --project Agentica.CLI -- workbench run broken_check --planner gemini --thinking-budget off --timeout-seconds 120
# Succeeded with workbench.objective_completed artifact

dotnet run --project Agentica.CLI -- workbench run broken_check --planner gemini --thinking-budget dynamic --timeout-seconds 120
# Succeeded with workbench.objective_completed artifact

dotnet run --project Agentica.CLI -- workbench run missing_mapping --planner gemini --thinking-budget off --timeout-seconds 180
...
dotnet run --project Agentica.CLI -- workbench run word_ladder --planner gemini --thinking-budget off --timeout-seconds 180
