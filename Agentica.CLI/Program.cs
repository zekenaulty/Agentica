...
static void PrintUsage()
{
    ...
    Console.Error.WriteLine("  Agentica.CLI chessquest legal-action-probe [--trials <count>] [--seed <number>] [--scramble-plies <count>] [--presentation ascii|fen|both] [--model <model-id>] [--thinking-budget dynamic|off|<tokens>] [--max-output-tokens <count>] [--timeout-seconds <seconds>] [--json] [--log-run] [--log-dir <path>]");
    Console.Error.WriteLine("  Agentica.CLI chessquest puzzle-probe [--trials <count>] [--presentation ascii|fen|both] [--model <model-id>] [--thinking-budget dynamic|off|<tokens>] [--max-output-tokens <count>] [--timeout-seconds <seconds>] [--json] [--log-run] [--log-dir <path>]");
    Console.Error.WriteLine("  Agentica.CLI chessquest state-probe [--probe-kind legality|capture|check|material|phase|stacked] [--trials <count>] [--seed <number>] [--scramble-plies <count>] [--presentation ascii|fen|both] [--model <model-id>] [--thinking-budget dynamic|off|<tokens>] [--max-output-tokens <count>] [--timeout-seconds <seconds>] [--json] [--log-run] [--log-dir <path>]");
