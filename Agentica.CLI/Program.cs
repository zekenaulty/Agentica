...
static void PrintUsage()
{
    ...
    Console.Error.WriteLine("  Agentica.CLI chessquest board-probe [--trials <count>] [--seed <number>] [--scramble-plies <count>] [--presentation ascii|fen|both] [--target occupied|empty|mixed] [--model <model-id>] [--thinking-budget dynamic|off|<tokens>] [--max-output-tokens <count>] [--timeout-seconds <seconds>] [--json]");
